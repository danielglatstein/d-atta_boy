module Adapters
  class MlbScraper
    ...
    def page_navigation
      ...
      navigate_through_years(page, 2015, 2015, 10, 10)
    end

    def navigate_through_years(page, first_year=2015, final_year=2015, first_month=4, final_month=11)
      (first_year..final_year).each do |year|
        ...
        (first_month..final_month).each do |month|
          ...
          navigate_through_month(month) do |game_page| 
    ...
    def navigate_through_month(month)
      month.links[1..-1].each do |day_page_link|
